          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Gambar</label>
                <img src="/storage/app/public/gambar-barang/" class="img-preview img-fluid my-1" id="detail_gambar_preview" style="max-height: 275px; overflow:hidden; border: 1px solid black;">
              </div>
            </div>
